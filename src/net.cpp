...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Amiga " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"212.56.109.179", "212.56.109.179"},
    {"37.187.135.212", "37.187.135.212"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Amiga is probably already running."), addrBind.ToString().c_str());
        else
